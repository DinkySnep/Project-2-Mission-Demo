...
public class ProjectileLine : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _line.positionCount = 1;    // chaning this to just equal one rather than ++ fixes it creating a renderpoint at 0,0,0
    ...
    static void ADD_LINE(ProjectileLine newLine)
    {
        ...
        // Ittterate over all the old lines and dim them
